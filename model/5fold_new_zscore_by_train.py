...
#预定义
data_path = '/raid2/guocc/MetaComb/fix/data'
cell_feature_path = '/raid2/guocc/MetaComb/fix/data/log2_tpm_cell.csv'
save_path = '/raid2/guocc/MetaComb/fix/5fold_new/'
cuda=True
...
#预训练
#源域：细胞系的源于数据
df =  pd.read_pickle("/raid2/litt/DATA!!/cl_label_data_onlysmiles_1016.pickle") 
df = df.drop(columns = ['css_ri','S_sum'])
drug_features =  pd.read_csv("/raid2/litt/DATA!!/4130_drug_smiles_cid.csv")
